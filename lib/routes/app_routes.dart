...
import 'package:manas_s_application2/presentation/splash_screen/splash_screen.dart';
import 'package:manas_s_application2/presentation/walkthrough_one_screen/walkthrough_one_screen.dart';
import 'package:manas_s_application2/presentation/walkthrough_two_screen/walkthrough_two_screen.dart';
import 'package:manas_s_application2/presentation/walkthrough_three_screen/walkthrough_three_screen.dart';
import 'package:manas_s_application2/presentation/lets_in_screen/lets_in_screen.dart';
import 'package:manas_s_application2/presentation/sign_up_blank_form_screen/sign_up_blank_form_screen.dart';
import 'package:manas_s_application2/presentation/sign_in_blank_form_screen/sign_in_blank_form_screen.dart';
import 'package:manas_s_application2/presentation/choose_your_interest_screen/choose_your_interest_screen.dart';
import 'package:manas_s_application2/presentation/tell_us_about_yourself_screen/tell_us_about_yourself_screen.dart';
import 'package:manas_s_application2/presentation/when_is_your_birthday_screen/when_is_your_birthday_screen.dart';
import 'package:manas_s_application2/presentation/fill_your_profile_blank_form_screen/fill_your_profile_blank_form_screen.dart';
import 'package:manas_s_application2/presentation/create_new_pin_screen/create_new_pin_screen.dart';
import 'package:manas_s_application2/presentation/set_your_fingerprint_screen/set_your_fingerprint_screen.dart';
import 'package:manas_s_application2/presentation/forgot_password_methods_screen/forgot_password_methods_screen.dart';
import 'package:manas_s_application2/presentation/forgot_password_type_otp_screen/forgot_password_type_otp_screen.dart';
import 'package:manas_s_application2/presentation/forgot_password_filled_otp_screen/forgot_password_filled_otp_screen.dart';
import 'package:manas_s_application2/presentation/create_new_password_screen/create_new_password_screen.dart';
import 'package:manas_s_application2/presentation/home_container_screen/home_container_screen.dart';
import 'package:manas_s_application2/presentation/report_screen/report_screen.dart';
import 'package:manas_s_application2/presentation/sound_used_screen/sound_used_screen.dart';
import 'package:manas_s_application2/presentation/profile_screen/profile_screen.dart';
import 'package:manas_s_application2/presentation/followers_tab_container_screen/followers_tab_container_screen.dart';
import 'package:manas_s_application2/presentation/send_message_screen/send_message_screen.dart';
import 'package:manas_s_application2/presentation/search_type_keyword_screen/search_type_keyword_screen.dart';
import 'package:manas_s_application2/presentation/search_results_users_tab_container_screen/search_results_users_tab_container_screen.dart';
import 'package:manas_s_application2/presentation/see_live_screen/see_live_screen.dart';
import 'package:manas_s_application2/presentation/weekly_ranking_tab_container_screen/weekly_ranking_tab_container_screen.dart';
import 'package:manas_s_application2/presentation/trending_sounds_details_screen/trending_sounds_details_screen.dart';
import 'package:manas_s_application2/presentation/trending_hashtag_details_screen/trending_hashtag_details_screen.dart';
import 'package:manas_s_application2/presentation/posts_quick_photo_screen/posts_quick_photo_screen.dart';
import 'package:manas_s_application2/presentation/posts_quick_video_screen/posts_quick_video_screen.dart';
import 'package:manas_s_application2/presentation/posts_camera_screen/posts_camera_screen.dart';
import 'package:manas_s_application2/presentation/posts_templates_screen/posts_templates_screen.dart';
import 'package:manas_s_application2/presentation/posts_add_sounds_tab_container_screen/posts_add_sounds_tab_container_screen.dart';
import 'package:manas_s_application2/presentation/posts_upload_media_tab_container_screen/posts_upload_media_tab_container_screen.dart';
import 'package:manas_s_application2/presentation/posts_edit_page_screen/posts_edit_page_screen.dart';
import 'package:manas_s_application2/presentation/go_live_screen/go_live_screen.dart';
import 'package:manas_s_application2/presentation/all_activity_dropdown_screen/all_activity_dropdown_screen.dart';
import 'package:manas_s_application2/presentation/messages_screen/messages_screen.dart';
import 'package:manas_s_application2/presentation/messages_box_screen/messages_box_screen.dart';
import 'package:manas_s_application2/presentation/type_message_screen/type_message_screen.dart';
import 'package:manas_s_application2/presentation/call_screen/call_screen.dart';
import 'package:manas_s_application2/presentation/find_friends_screen/find_friends_screen.dart';
import 'package:manas_s_application2/presentation/edit_profile_screen/edit_profile_screen.dart';
import 'package:manas_s_application2/presentation/settings_screen/settings_screen.dart';
import 'package:manas_s_application2/presentation/manage_accounts_screen/manage_accounts_screen.dart';
import 'package:manas_s_application2/presentation/privacy_screen/privacy_screen.dart';
import 'package:manas_s_application2/presentation/security_screen/security_screen.dart';
import 'package:manas_s_application2/presentation/qr_code_screen/qr_code_screen.dart';
import 'package:manas_s_application2/presentation/language_screen/language_screen.dart';
import 'package:manas_s_application2/presentation/privacy_policy_screen/privacy_policy_screen.dart';
import 'package:manas_s_application2/presentation/app_navigation_screen/app_navigation_screen.dart';
